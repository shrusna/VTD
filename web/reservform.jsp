...
<div class="contact-form">
    <form action="reservation.jsp" name="form1" >
    	<table class="table1">
    <tfoot>
    	<tr>
    ...
    <tr>
        <td><p>NIK*</p></td>
        <td><H1> : </H1></td>
        <td colspan="2"><input type="text" name="nik" placeholder="NIK" required=""></td>
    </tr>
    <tr>    
        <td width="100"></td>
    </tr>   
    <tr>
        ...
        <td><H1> : </H1></td>
        <td colspan="2"><input type="text" name="reservfirst" placeholder="First Name" required=""></td>
    </tr>
    <tr>
        <td><p>Last Name</p></td>
        <td><H1> : </H1></td>
        <td colspan="2"><input type="text" name="reservlast" placeholder="Last Name"></td>
    </tr>
    <tr>
        <td><p>Gender*</p></td>
        <td><H1> : </H1></td>
    ...
    <tr class="tr1">
        ...
        <td><H1> : </H1></td>
        <td><input align="center" name="datebd" type="number" min="1" max="30" required="" placeholder="DD"></td>
        <td><input align="center" name="datebm" type="text" max="20" required="" placeholder="MM"></td>
        <td><input align="center" name="dateby" type="number" min="1970" max="2019" required="" placeholder="YYYY"></td>
    </tr>
    <tr>
        <td><p>ADDRESS*</p></td>
        <td><H1> : </H1></td>
        <td colspan="2"><input type="text" name="address" rows="5" cols="30" required=""></td>
    </tr>
    <tr>
        <td><p>Email*</p></td>
        <td><H1> : </H1></td>
        <td colspan="2"><input type="email" name="reservemail" placeholder="Enter Your Email" required=""></td>
    </tr>
    <tr>    
        <td><p>Phone No.*</p></td>
        <td><H1> : </H1></td>
        <td colspan="2"><input type="text" name="reservphone1" placeholder="Phone No." required=""></td>
    </tr>
    <tr>    
        <td><p>Phone No.</p></td>
        <td><H1> : </H1></td>
        <td colspan="2"><input type="text" name="reservphone2" placeholder="Phone No."></td>
    </tr>
    <tr class="tr2">    
        <td><p>Date of Departure*</p></td>
        <td><H1> : </H1></td>
        <td><input align="center" name="datedd" type="number" min="1" max="30" required="" placeholder="DD"></td>
        <td><input align="center" name="datedm" type="text" max="20" required="" placeholder="MM"></td>
        <td><input align="center" name="datedy" type="number" min="2010" max="2019" required="" placeholder="YYYY"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td><p>MEMO</p></td>
        <td><H1> : </H1></td>
        <td colspan="2"><input type="text" name="memo" rows="5" cols="30"></td>
    </tr>
    <tr>
        <td><p>Total Price</p></td>
        <td><H1> : </H1></td>
        <td colspan="2"><input name="total" value="0" readonly type="text" id="total" /></td>
        <td><p>Rp</p></td>
    </tr>
        <tr>
            <td height="20"></td>
...
<div class="contact-form2">
	<a href="reservid.jsp"><img src="img/reserve.png"></a>
</div>
<div class="form">
	<a href="home.jsp"><img src="img/tours.png"></a>
</div>
<div class="butt1">
...
<div class="butt3">
	<a href="kontak.jsp"><img src="img/kontak.png">
</div>
</body>
</html>